...
#    d_l1_p = tf.nn.max_pool(d_l1_a, max_s, max_s, padding='VALID') # 128
    ...
    d_l4_a = tf.layers.conv2d(d_l3_p, 64, 3, activation=tf.nn.relu, padding='same', name='c7')
    ...
    d_l5_a = tf.layers.conv2d(d_l4_p, 64, 3, activation=tf.nn.relu, padding='same', name='c9')
    ...
    d_l6_a = tf.layers.conv2d(d_l5_p, 128, 3, activation=tf.nn.relu, padding='same', name='c11')
    ...
    u_l4_a = tf.layers.conv2d_transpose(u_l5_s, 128, 3, 2, activation=tf.nn.relu, padding='same', name='c28') # 32
    ...
    u_l3_a = tf.layers.conv2d_transpose(u_l4_s, 128, 3, 2, activation=tf.nn.relu, padding='same', name='30') # 64
...
#    u_l1_s = tf.layers.conv2d(u_l1_c, 63, 3, activation=tf.nn.relu, padding='same')
    ...
    moves_logits = tf.layers.conv2d(u_l2_s_4, 6, 3, activation=None, padding='same', name='c40')
