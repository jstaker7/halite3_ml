...
def build_model(inference=False, num_players=1, learning_rate=None, fine_tune=False):
    ...
    d_l4_a = tf.layers.conv2d(d_l3_p, 32, 3, activation=tf.nn.leaky_relu, padding='same', name='c7')
    ...
    d_l5_a = tf.layers.conv2d(d_l4_p, 32, 3, activation=tf.nn.leaky_relu, padding='same', name='c9')
    ...
    d_l6_a = tf.layers.conv2d(d_l5_p, 64, 3, activation=tf.nn.leaky_relu, padding='same', name='c11')
    ...
    d_l7_a = tf.layers.conv2d(d_l6_p, 128, 3, activation=tf.nn.leaky_relu, padding='same', name='c13')
    ...
    d_l8_a_2 = tf.layers.conv2d(d_l7_p, 128, 3, activation=tf.nn.leaky_relu, padding='same', name='c16')
    ...
    latent = tf.layers.dense(final_state, 256, activation=tf.nn.leaky_relu, name='c19')
    ...
    for i in range(num_players):
        ...
        gen_latent = tf.layers.dense(latent, 64, activation=tf.nn.leaky_relu, name='c39_{}'.format(i))
